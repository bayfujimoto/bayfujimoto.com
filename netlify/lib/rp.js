...
//
//   WEBAUTHN_RP_ID            e.g. "bayfujimoto.com"
//   WEBAUTHN_RP_NAME          e.g. "bayfujimoto archive"
//   WEBAUTHN_EXPECTED_ORIGIN  e.g. "https://bayfujimoto.com"

export function getRP() {
  const rpID = process.env.WEBAUTHN_RP_ID || "localhost";
  const rpName = process.env.WEBAUTHN_RP_NAME || "bayfujimoto archive";
