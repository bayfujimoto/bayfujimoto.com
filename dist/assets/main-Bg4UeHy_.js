  ...
  `;const s=()=>r({layer:"desk"});t.querySelector(".sheet-close").addEventListener("click",s);const l=x(t,s);return requestAnimationFrame(()=>{var n;return(n=t.querySelector(".sheet-close"))==null?void 0:n.focus()}),{veil:e,sheet:t,cleanup:l}}function le(e,t,s,l){const n=y.series[e],i=T.has(e),m=i?[]:Object.entries(n.subcollections);function o(){return n.items?n.items:Object.values(n.subcollections||{}).flatMap(d=>d.items||[])}const g=q(()=>{r(i?{layer:"desk"}:{layer:"series",series:e,subcollection:null,item:null})}),p=A();function k(d,v){let b,_;if(i){let a=o();v&&v!=="all"&&(a=a.filter(f=>f.context===v||f.view===v)),b={label:v||"all",items:a},_=H(a)}else b=n.subcollections[d],_=H((b==null?void 0:b.items)||[]);p.innerHTML=`
      <div class="layer-sheet__inner">
        ...
        <div class="browse-header">
          <h2 class="sheet-title">${b.label}</h2>
          <p class="browse-count">${b.items.length} item${b.items.length!==1?"s":""}</p>
          ${m.length===0?'<p class="browse-groupby-stub" aria-label="Sort options coming in a later phase">group by: year · context · place · type</p>':m.length===1?'<p class="browse-groupby-stub" aria-label="Sort options coming in a later phase">group by: year · event · place · type</p>':""}
        </div>
    ...
    `,p.querySelector(".sheet-close").addEventListener("click",()=>{r(i?{layer:"desk"}:{layer:"series",series:e,subcollection:null,item:null})}),p.querySelectorAll(".series-tab").forEach(a=>{a.addEventListener("click",()=>{r({layer:"browse",series:a.dataset.series,subcollection:a.dataset.sub,item:null})})}),p.querySelectorAll(".browse-item__trigger").forEach(a=>{a.addEventListener("click",()=>{r({layer:"item",series:e,subcollection:d,view:v,item:a.dataset.itemId})})})}const u=x(p,()=>{r(i?{layer:"desk"}:{layer:"series",series:e,subcollection:null,item:null})});k(t,s),requestAnimationFrame(()=>{var d;return(d=p.querySelector(".sheet-close"))==null?void 0:d.focus()});function c(d){d.subcollection&&d.subcollection!==t&&(t=d.subcollection,k(t,s)),d.view&&d.view!==s&&(s=d.view,k(t,s))}return{veil:g,sheet:p,update:c,cleanup:u}}function ne(e,t,s){const l=y.series[e];let n;t&&l.subcollections[t]?n=l.subcollections[t].items:Object.keys(l.subcollections||{}).length>0?n=Object.values(l.subcollections).flatMap(u=>u.items||[]):n=l.items||[];let i=n.findIndex(u=>u.id===s);i===-1&&(i=0);const m=q(()=>{r({layer:"browse",series:e,subcollection:t,item:null})}),o=A("layer-sheet--item");function g(u){var b,_,a;i=u;const c=n[u],d=u>0,v=u<n.length-1;o.innerHTML=`
      <div class="layer-sheet__inner layer-sheet__inner--item">
        ...
        <div class="inspection-modal__content">
          ...
          <div class="inspection-modal__meta-col">
            ...
            ${ae(c,n)}
            ${(b=c.tags)!=null&&b.length?`<div class="modal-section"><h3 class="modal-section__label">tags</h3><p>${c.tags.join(" · ")}</p></div>`:""}
    ...
    `,o.querySelector(".sheet-close").addEventListener("click",()=>{r({layer:"browse",series:e,subcollection:t,item:null})}),(_=o.querySelector(".inspection-modal__prev"))==null||_.addEventListener("click",()=>{i>0&&p(i-1)}),(a=o.querySelector(".inspection-modal__next"))==null||a.addEventListener("click",()=>{i<n.length-1&&p(i+1)}),re(o),o.querySelectorAll(".modal-related__link").forEach(f=>{f.addEventListener("click",()=>{const I=f.dataset.relatedId,O=n.findIndex(N=>N.id===I);O!==-1&&p(O)})}),o.querySelector(".sheet-close").focus()}function p(u){g(u),W({layer:"item",series:e,subcollection:t,item:n[u].id})}const k=u=>{var c;((c=h[h.length-1])==null?void 0:c.sheet)===o&&(u.key==="Escape"&&r({layer:"browse",series:e,subcollection:t,item:null}),u.key==="ArrowLeft"&&i>0&&p(i-1),u.key==="ArrowRight"&&i<n.length-1&&p(i+1))};document.addEventListener("keydown",k);const M=()=>document.removeEventListener("keydown",k);return g(i),{veil:m,sheet:o,cleanup:M}}function x(e,t){const s=l=>{var n;l.key==="Escape"&&((n=h[h.length-1])==null?void 0:n.sheet)===e&&t()};return document.addEventListener("keydown",s),()=>document.removeEventListener("keydown",s)}function q(e){const t=document.createElement("div");return t.className="layer-veil",t.setAttribute("aria-hidden","true"),t.addEventListener("click",e),t}function A(e=""){const t=document.createElement("div");return t.className=`layer-sheet ${e}`.trim(),t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t}function P(e){var t,s,l,n,i,m,o;return((t=e.assets)==null?void 0:t.front)||((s=e.assets)==null?void 0:s.poster)||((l=e.assets)==null?void 0:l.cover)||((n=e.assets)==null?void 0:n.primary)||((o=(m=(i=e.assets)==null?void 0:i.gallery)==null?void 0:m[0])==null?void 0:o.file)||null}function ie(e){var l;const t=j((l=e.assets)==null?void 0:l.thumbnail,"thumbnail")||j(P(e),"original"),s=t?`<img src="${t}" alt="" loading="lazy">`:"";return`
